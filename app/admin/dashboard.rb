ActiveAdmin.register_page "Dashboard" do
  ...
  content title: proc { I18n.t("active_admin.dashboard") } do
    ...
    panel "Firmas por sección (En lista nominal)" do
        ...
        column_chart Registro.where.not(seccion: nil).where(status: "LISTA NOMINAL (PRELIMINARMENTE)").group(:seccion).count
